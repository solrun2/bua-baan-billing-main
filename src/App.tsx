...
import Ewallets from "./pages/finance/Ewallets";
import EwalletDetail from "./pages/finance/EwalletDetail";
        ...
        <BrowserRouter>
          <Layout>
            <Routes>
              ...
              />
              <Route path="/finance/ewallets" element={<Ewallets />} />
              <Route path="/finance/ewallets/:id" element={<EwalletDetail />} />
